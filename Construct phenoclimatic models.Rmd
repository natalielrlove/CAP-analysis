...
##Explore data with histograms and simple plots
1. Look at distribution of DOY
```{r}
#histogram for DOY using base graphics code
graphics::hist(esca_pheno_climate$startDayOfYear, main = "Histogram of DOY", xlab = "DOY")

#histogram using ggplot2
ggplot(data = esca_pheno_climate, aes(x = startDayOfYear)) + geom_histogram(binwidth = 30, color ="black", fill = "white") + 
  theme_bw()

#you can also look at histograms of transformations (log and square root shown here)
ggplot(data = esca_pheno_climate, aes(x = log10(esca_pheno_climate$startDayOfYear))) + geom_histogram(binwidth = 0.1, color = "black", fill = "white") + theme_bw()
